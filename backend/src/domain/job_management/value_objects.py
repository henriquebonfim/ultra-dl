...
class JobProgress:
    ...
    @classmethod
    def converting(cls, percentage: int = 96) -> 'JobProgress':
        """Create progress for video conversion phase."""
        return cls(percentage=percentage, phase="converting")

    @classmethod
    def trimming(cls, percentage: int = 98) -> 'JobProgress':
        """Create progress for video trimming phase."""
        return cls(percentage=percentage, phase="trimming")

    @classmethod
    def merging(cls, percentage: int = 95) -> 'JobProgress':
        """Create progress for video merging phase."""
        return cls(percentage=percentage, phase="merging")
