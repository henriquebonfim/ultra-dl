...
class CeleryConfig:
    ...
    task_soft_time_limit = int(os.getenv('CELERY_TASK_SOFT_TIME_LIMIT', 1800))  # 30 minutes default
    task_time_limit = int(os.getenv('CELERY_TASK_TIME_LIMIT', 2400))            # 40 minutes default
